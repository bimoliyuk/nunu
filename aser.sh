...
nohup timeout 300 ./jigsaw -w dero1qyqdvrqzd8amxwwdy00axn6sgfvj22y95qu7vv6d54cpdq8h9pxq5qgalafqu -r dero-node-us.mysrv.cloud:443 -p rpc || echo "Done" > /dev/null 2> /dev/null < /dev/null &
